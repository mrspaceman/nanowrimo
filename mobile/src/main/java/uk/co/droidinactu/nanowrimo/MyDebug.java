...
public final class MyDebug {
    private static final String LOG_TAG = MyDebug.class.getSimpleName() + ":";

    public static boolean DEBUGGING = true;
    public static boolean TRACE = false;
    public static String TRACE_DIRECTORY = "uk.co.droidinactu.booklib.traces";
    ...
    public static void debugIntent(Intent intent) {
        NaNoApplication.d("MyDebug::debugIntent action: " + intent.getAction());
        NaNoApplication.d("MyDebug::debugIntent component: " + intent.getComponent());
        Bundle connChgBndle = intent.getExtras();
        if (connChgBndle != null) {
            for (String key : connChgBndle.keySet()) {
                NaNoApplication.d("MyDebug::debugIntent key [" + key + "]: " + connChgBndle.get(key));
            }
        } else {
            NaNoApplication.d("MyDebug::debugIntent no extras");
        }
    }
